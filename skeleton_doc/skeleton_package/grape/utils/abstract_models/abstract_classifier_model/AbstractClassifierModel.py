...
class AbstractClassifierModel:
    ...
    def split_graph_following_evaluation_schema(cls: None, graph: Graph, evaluation_schema: str, holdout_number: int, number_of_holdouts: int) -> Tuple:
