...
def get_kgx_okapi_tfidf_weighted_textual_embedding(name: str, repository: str, columns: typing.Optional[typing.List[str]], version: str, k1: float, b: float, pretrained_model_name_or_path: str, bert_model_kwargs: typing.Optional[typing.Dict], verbose: bool) -> numpy.ndarray:
